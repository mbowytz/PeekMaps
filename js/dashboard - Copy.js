    ...
    function cm_sortRows(rowA, rowB) {
      var rowAValue = parseFloat(rowA[param_rankColumn].$t);
      var rowBValue = parseFloat(rowB[param_rankColumn].$t);
    ...
    function cm_loadMapJSON(json) {
      ...
      //if(param_useSidebar == true) {
        ...
        document.getElementById("sidebar").appendChild(sidebarTD);
      //}
     
      var bounds = new google.maps.LatLngBounds();
     
      if(json.feed.entry[0][param_rankColumn]) {
        usingRank = true;
    ...
    function cm_getJSON() {
      ...
      //var jsonSource = 'http://spreadsheets.google.com/feeds/list'
      //                       + '/' + param_ssKey + '/' + param_wsId + '/public/values' +
      //                      '?alt=json-in-script&callback=cm_loadMapJSON';
      //         alert(jsonSource);
      var jsonSource = 'http://localhost/db_json.php?callback=cm_loadMapJSON';
